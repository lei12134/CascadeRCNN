...
class AnchorsGenerator(nn.Module):
    ...
    def __init__(self, sizes=(128, 256, 512), aspect_ratios=(0.5, 1.0, 2.0)):
        ...
        self._cache = {}  # feature_maps -> anchors
    ...
    def set_cell_anchors(self, dtype, device):
        ...
        # 依次遍历每张特征图对应的 anchors 比例, 得到所有特征图对应的 anchors 模板
    ...
    def grid_anchors(self, grid_sizes, strides):
        ...
        """
        anchors = []
        cell_anchors = self.cell_anchors  # anchors 模板
        assert cell_anchors is not None
...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def __init__(self, anchor_generator, head, box_coder,
        ...
        self.head = head
        self.box_coder = box_coder  # det_utils.BoxCoder(weights=(1.0, 1.0, 1.0, 1.0))
